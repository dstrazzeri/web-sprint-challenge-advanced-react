...
Your test cases should be broken down into three stages: To begin, you must arrange some items ("Arrange"). Then you take action ("Act"). Then you double-check("Assert") that what you predicted actually happened.
